...
export const verifyOtp = async (payload) => (await apiClient.post("/api/auth/verify-otp", payload)).data;
export const resendOtp = async (payload) => (await apiClient.post("/api/auth/resend-otp", payload)).data;
